...
def generate_launch_description():
    ...
    default_world_path = os.path.join(go2_simulation, "worlds/TIbuilding.sdf")
    ...
    gazebo_resource_path = AppendEnvironmentVariable(
        ...
        value=os.path.join(go2_simulation, "models"),
    )
    ...
    controller_spawner_effort = TimerAction(
        period=30.0,  # Wait 5 seconds after joint_state_broadcaster
        actions=[
            Node(
                package="controller_manager",
                executable="spawner",
