...
def generate_launch_description():
    ...
    workspace_path = os.path.abspath(
        os.path.join(unitree_go2_sim, "..", "..", "..", "..")
    )
    small_city_package = os.path.join(
        workspace_path,
        "src",
    ...
    default_world_path = os.path.join(small_city_package, "worlds/small_city.sdf")
    small_city_models_path = os.path.join(small_city_package, "models")
    ...
    declare_world_init_z = DeclareLaunchArgument("world_init_z", default_value="0.625")
    ...
    gazebo_resource_path = AppendEnvironmentVariable(
        ...
        value=os.path.join(unitree_go2_description, "models"),
    )
    small_city_resource_path = AppendEnvironmentVariable(
        name="GZ_SIM_RESOURCE_PATH",
